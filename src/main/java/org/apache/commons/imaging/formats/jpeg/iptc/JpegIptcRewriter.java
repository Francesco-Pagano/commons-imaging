...
public class JpegIptcRewriter extends JpegRewriter {
     ...
     */
    public void removeIptc(final byte[] src, final OutputStream os) throws IOException {
     ...
     * @throws ImagingException if it fails to write the target image
     */
    public void removeIptc(final byte[] src, final OutputStream os, final boolean removeSegment) throws IOException {
     ...
     * @throws ImagingException if it fails to write the target image
     */
    public void removeIptc(final ByteSource byteSource, final OutputStream os) throws IOException {
     ...
     */
    public void removeIptc(final File src, final OutputStream os) throws IOException {
        removeIptc(src, os, false);
    }
     ...
     * @throws ImagingException if it fails to write the target image
     */
    public void removeIptc(final File src, final OutputStream os, final boolean removeSegment) throws IOException {
     ...
     * @throws ImagingException if it fails to write the target image
     */
    public void removeIptc(final InputStream src, final OutputStream os) throws IOException {
        removeIptc(src, os, false);
    }
     ...
     * @throws ImagingException if it fails to write the target image
     */
    public void removeIptc(final InputStream src, final OutputStream os, final boolean removeSegment) throws IOException {
     ...
     * @throws ImagingException if it fails to write the target image
     */
    public void writeIptc(final byte[] src, final OutputStream os, final PhotoshopApp13Data newData) throws IOException {
        final ByteSource byteSource = ByteSource.array(src);
     ...
     * @throws ImagingException if it fails to write the target image
     */
    public void writeIptc(final File src, final OutputStream os, final PhotoshopApp13Data newData) throws IOException {
        final ByteSource byteSource = ByteSource.file(src);
        writeIptc(byteSource, os, newData);
    }
