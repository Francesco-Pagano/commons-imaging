...
public enum IccTagTypes implements IccTagType {
    A_TO_B0_TAG("AToB0Tag", "lut8Type or lut16Type or lutAtoBType", 0x41324230
    ),

    A_TO_B1_TAG("AToB1Tag", "lut8Type or lut16Type or lutAtoBType", 0x41324231
    ...
    A_TO_B2_TAG("AToB2Tag", "lut8Type or lut16Type or lutAtoBType", 0x41324232
    // "This tag defines a color transform from Device to PCS using lookup table tag element structures. The processing",
    // "mechanisms are described in lut8Type or lut16Type or lutAtoBType.",
    ),

    BLUE_MATRIX_COLUMN_TAG("blueMatrixColumnTag", "XYZType", 0x6258595A
    // "The third column in the matrix used in TRC/matrix transforms.",
    ),

    BLUE_TRC_TAG("blueTRCTag", "curveType or parametricCurveType", 0x62545243
    ...
    B_TO_A0_TAG("BToA0Tag", "lut8Type or lut16Type or lutBtoAType", 0x42324130
    ...
    B_TO_A1_TAG("BToA1Tag", "lut8Type or lut16Type or lutBtoAType", 0x42324131
    // "This tag defines a color transform from PCS to Device using the lookup table tag element structures. The",
    // "processing mechanisms are described in lut8Type or lut16Type or lutBtoAType.",
    ),

    B_TO_A2_TAG("BToA2Tag", "lut8Type or lut16Type or lutBtoAType", 0x42324132
    // "This tag defines a color transform from PCS to Device using the lookup table tag element structures. The",
    // "processing mechanisms are described in lut8Type or lut16Type or lutBtoAType.",
    ),

    CALIBRATION_DATE_TIME_TAG("calibrationDateTimeTag", "dateTimeType", 0x63616C74
    ...
    CHAR_TARGET_TAG("charTargetTag", "textType", 0x74617267
    ...
    CHROMATIC_ADAPTATION_TAG("chromaticAdaptationTag", "s15Fixed16ArrayType", 0x63686164
    ...
    CHROMATICITY_TAG("chromaticityTag", "chromaticityType", 0x6368726D
    // "The data and type of phosphor/colorant chromaticity set.",
    ),

    COLORANT_ORDER_TAG("colorantOrderTag", "colorantOrderType", 0x636C726F
    // "This tag specifies the laydown order of colorants.",
    ),

    COLORANT_TABLE_TAG("colorantTableTag", "colorantTableType", 0x636C7274
    ...
    COPYRIGHT_TAG("copyrightTag", "multiLocalizedUnicodeType", 0x63707274
    // "This tag contains the text copyright information for the profile.",
    ),

    DEVICE_MFG_DESC_TAG("deviceMfgDescTag", "multiLocalizedUnicodeType", 0x646D6E64
    ...
    GAMUT_TAG("gamutTag", "lut8Type or lut16Type or lutBtoAType", 0x67616D74
    ...
    GRAY_TRC_TAG("grayTRCTag", "curveType or parametricCurveType", 0x6B545243
    ...
    GREEN_MATRIX_COLUMN_TAG("greenMatrixColumnTag", "XYZType", 0x6758595A
